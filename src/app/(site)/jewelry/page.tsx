    ...
    <>
      <div className="pad-x pad-t border-b border-line bg-warm pb-[40px]">
        ...
        <div className="mt-[28px] flex flex-wrap gap-[8px]">
          <Link
            href="/diamonds"
            className="inline-flex min-h-[44px] items-center rounded-[3px] border border-ink px-[16px] py-[10px] text-[12px] uppercase tracking-[.08em] text-ink"
          >
            О бриллиантах
          </Link>
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="inline-flex min-h-[44px] items-center rounded-[3px] border border-line2 px-[16px] py-[10px] text-[12px] uppercase tracking-[.08em] text-ink transition-colors hover:border-ink"
          >
